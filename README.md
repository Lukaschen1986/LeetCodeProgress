...
- [0026.删除排序数组中的重复项](https://leetcode-cn.com/problems/remove-duplicates-from-sorted-array/)  [->解答](./array/26_removeDuplicates.py)
- [0027.移除元素](https://leetcode-cn.com/problems/remove-element/)  [->解答](./array/27_removeElement.py)
- [0048.旋转图像](https://leetcode-cn.com/problems/rotate-image/)  [->解答](./array/48_rotate.py)
- [0054.螺旋矩阵](https://leetcode-cn.com/problems/spiral-matrix/)  [->解答 代码简洁但耗时](./array/54_spiralOrder.py)
- [0056.合并区间](https://leetcode-cn.com/problems/merge-intervals/)  [->解答](./array/56_merge.py)
...
- [0014.最长公共前缀](https://leetcode-cn.com/problems/longest-common-prefix/)  [->解答](./string/14_longestCommonPrefix.py)
- [0020.有效的括号](https://leetcode-cn.com/problems/valid-parentheses/)  [->解答](./string/20_isValid.py)
- [0007.整数反转](https://leetcode-cn.com/problems/reverse-integer/)  [->解答](./string/7_reverse.py)
- [0009.回文数](https://leetcode-cn.com/problems/palindrome-number/)  [->解答](./string/9_isPalindrome.py)
- [0028.实现 strStr()](https://leetcode-cn.com/problems/implement-strstr/)  [->解答](./string/28_strStr.py)
- [0036.有效的数独](https://leetcode-cn.com/problems/valid-sudoku/)  [->解答](./string/36_isValidSudoku.py)
- [0049.字母异位词分组](https://leetcode-cn.com/problems/group-anagrams/)  [->解答](./string/49_groupAnagrams.py)
- [0066.加一](https://leetcode-cn.com/problems/plus-one/)  [->解答](./string/66_plusOne.py)

### 3、动规
- [0032.最长有效括号](https://leetcode-cn.com/problems/longest-valid-parentheses/)  [->解答](./dp/32_longest_valid_parentheses.py)
- [0010.正则表达式匹配](https://leetcode-cn.com/problems/regular-expression-matching/)  [->解答](./dp/10_isMatch.py)
...
- [0055.跳跃游戏](https://leetcode-cn.com/problems/jump-game/)  [->解答](./dp/55_canJump.py)
- [0198.打家劫舍](https://leetcode-cn.com/problems/house-robber/)  [->解答](./dp/198_rob.py)
- [0213.打家劫舍 II](https://leetcode-cn.com/problems/house-robber-ii/)  [->解答](./dp/213_rob.py)
- [0064.最小路径和](https://leetcode-cn.com/problems/minimum-path-sum/)  [->解答](./dp/64_minPathSum.py)
- [0070.爬楼梯](https://leetcode-cn.com/problems/climbing-stairs/)  [->解答](./dp/70_climbStairs.py)
